      ...
      <div className="flex justify-center my-10">
        <div className="grid md:grid-cols-2 grid-cols-1 gap-4">
          ...
          <div className="flex flex-col justify-center gap-4">
            ...
            <p className="md:text-lg text-sm text-[#737F96] font-normal">A car diagnostic scan from your local dealership could cost up to £100 + VAT. Why not buy a scanner and do it yourself? They are easy to use. The scanner will pay for itself. You can then present the findings to your local mechanic who won’t have to run a diagnostics scan, thus saving time and money.</p>
          </div>
        </div>
